        ...
        link: function (scope, element) {
            ...
            scope.drawChartWithCalculation = function (svgChartHeight) {
                ...
                for (var i = 0; i < scope.totalChartBars; i++) {
                    ...
                    scope.nameList[remain - i]["x1"] = Math.round(barChartX + 8);
                    scope.nameList[remain - i]["x2"] = barChartX + scope.barSize;
            ...
            scope.drawXAxisMarkers = function (svgChartHeight) {
                for (var i = 0; i < scope.totalChartBars; i++) {
                    var remain = scope.totalChartBars - 1;
                    name = scope.chartDataList[remain - i].name;
            ...
            scope.update = function () {
                ...
                //If tooltip is end of width then change position of tooltip
                if (event.pageX + boxWidth > scope.width) {
                    xposition = xposition - boxWidth - 15;
